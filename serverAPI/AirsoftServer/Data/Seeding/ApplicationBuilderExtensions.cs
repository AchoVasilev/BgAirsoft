namespace Data.Seeding
{
    ...
    public static class ApplicationBuilderExtensions
    {
            ...
            var categories = new List<Category>
            {
                ...
                new Category()
                {
                    ...
                    SubCategories = new List<SubCategory>
                    {
                        ...
                        new SubCategory()
                        {
                            Name = "Радио/Комуникационна екипировка"
                        },
                        new SubCategory()
                        {
                ...
                new Category()
                {
                    ...
                    Image = new Image()
                    {
                        Url = "https://res.cloudinary.com/dpo3vbxnl/image/upload/v1649099269/BgAirsoft/accessories_htmctb.jpg",
                        Name = "attach_b1skox",
                        Extension = "jpg",
                    },
                    SubCategories = new List<SubCategory>
        ...
        private static async Task SeedCitiesAsync(ApplicationDbContext data)
        {
            if (data.Cities.Any())
            {
                return;
