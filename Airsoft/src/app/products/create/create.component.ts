...
export class CreateComponent implements OnInit {
  ...
  gunCreateFormGroup: FormGroup = this.formBuilder.group({
    ...
    'length': new FormControl(null, [Validators.required, Validators.min(1), Validators.max(999)]),
    'barrel': new FormControl(null, [Validators.required, Validators.min(1), Validators.max(999)]),
